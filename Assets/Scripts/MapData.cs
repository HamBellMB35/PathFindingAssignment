...
public class MapData : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (textFile == null)
        {
            ...
            textFile = Resources.Load(resourcePath + "/" + levelName) as TextAsset;
        }
    }
    ...
    public List<string> GetMapFromTextFile(TextAsset tAsset)
    {
        ...
        {
            Debug.LogWarning("Error: invalid Text File");
        }
        return lines;
    }
    ...
    {
        return GetMapFromTextFile(textFile);
    }
    ...
    public int[,] MakeMap()
    {
        ...
        {
            lines = GetMapFromTextFile(textFile);
        }
